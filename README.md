...
2. Open the project in Vivado 2020.1 by double clicking on the included XPR file found at "\<archive extracted location\>/Nexys-A7-100T-XADC/Nexys-A7-100T-XADC.xpr".
...
7. In the Program Device Wizard, enter "\<archive extracted location\>/Nexys-A7-100T-XADC/Nexys-A7-100T-XADC.runs/impl_1/top.bit" into the "Bitstream file" field. Then click **Program**.
